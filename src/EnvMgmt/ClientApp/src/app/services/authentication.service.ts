...
export class AuthenticationService {
  ...
  getUser() {
    ...
    //return this._http.get(this.myAppUrl + 'api/WinAuth')
    //  .map((res: Response) => {
    //    console.log("Response status code: " + res.status.toString());
    //    //return res;
    //    //if (res) {
    ...
    return this._http.get(this.myAppUrl + 'api/WinAuth').pipe(catchError(this.handleError));
